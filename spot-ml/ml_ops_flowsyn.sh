...
#NOTE: This version of ml_ops is intended to call on spot_May2017_flowsyn.conf in order to keep
#      separate the configurations needed to run ml tests against labeled data in the
#      flowsyn database.
...
source /etc/spot_May2017_flowsyn.conf
